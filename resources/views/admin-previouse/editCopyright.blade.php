                        ...
                        <form method="POST" action="{{url('/')}}/admin/edit_Copyright" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea required id="article-ckeditor" name="content" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="content">{{$item->content}}</textarea>
