...
<div class="bg-white shadow rounded-lg">
    <div class="px-6 py-4 border-b border-gray-200">
        <div>
            <h3 class="text-lg font-semibold text-gray-900">Add New Post</h3>
            <p class="text-sm text-gray-500 mt-1">Create blog posts</p>
        </div>
    </div>
    
    <form method="POST" action="{{url('/')}}/admin/add_Blog" enctype="multipart/form-data" class="px-6 py-6">
        @csrf
