...
<div class="mb-6">
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            ...
            <li>
                <a href="{{url('/')}}/admin/categories" class="text-gray-400 hover:text-gray-500">Categories</a>
            </li>
            <li>
                <span class="text-gray-500 mx-2">/</span>
            </li>
...
<div class="bg-white shadow rounded-lg">
    <div class="px-6 py-4 border-b border-gray-200">
        <div>
            <h3 class="text-lg font-semibold text-gray-900">Edit Category: {{ $Category->title }}</h3>
    ...
    <form method="POST" action="{{url('/')}}/admin/edit_Category/{{$Category->id}}" enctype="multipart/form-data" class="px-6 py-6">
        ...
        <div class="space-y-6">
            ...
            <div x-data="{ preview: '{{url('/')}}/uploads/categories/{{$Category->image}}', fileName: '' }">
                <label class="block text-sm font-medium text-gray-700 mb-2">Category Featured Image (440px x 550px recommended)</label>
                ...
                <div class="mt-2">
                    <img :src="preview" alt="Category Image Preview" class="h-64 w-auto object-cover rounded-lg border border-gray-200">
                </div>
