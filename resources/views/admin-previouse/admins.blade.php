...
<div class="mb-6">
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            ...
            <li>
                <span class="text-gray-900 font-medium">Administrators</span>
            </li>
            <li class="ml-auto">
    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Users with admin privileges</p>
            </div>
        </div>
    </div>
    <div class="px-6 py-4">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center space-x-3">
                            ...
                            <div x-data="{ 
                                confirmDelete() {
                                    if (confirm('Are you sure you want to delete this admin? Once deleted, you will not be able to recover this data!')) {
                    ...
                    <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500">
                        <div class="py-8">
                            ...
                            <a href="{{url('/')}}/admin/addUser" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                                <i class="fa fa-plus mr-2"></i> Add Your First Admin
                            </a>
                        </div>
                    </td>
                </tr>
