...
<div class="mb-6">
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            ...
            <li>
                <span class="text-gray-900 font-medium">Add Category</span>
            </li>
        </ol>
    </nav>
</div>
...
<div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-200">
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4 border-b border-indigo-800">
        <div>
            ...
            <p class="text-indigo-100 text-sm mt-1">Categories are used in both blogs and general content classification</p>
        </div>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div x-data="{ preview: null, fileName: '' }">
                <label class="block text-sm font-medium text-gray-700 mb-2">
                    Category Featured Image <span class="text-gray-500 text-xs">(Optional)</span>
                </label>
