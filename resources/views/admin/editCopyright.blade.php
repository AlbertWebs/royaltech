...
<div class="mb-6">
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            ...
            <li>
                <span class="text-gray-900 font-medium">Copyright</span>
            </li>
        </ol>
    </nav>
</div>
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4 border-b border-indigo-800">
        <div class="flex items-center">
            <div class="bg-white/20 rounded-lg p-2 mr-3">
                <i class="fa fa-copyright text-white text-xl"></i>
            </div>
            <div>
                <h3 class="text-lg font-semibold text-white">Edit Copyright</h3>
                <p class="text-indigo-100 text-sm mt-1">Update copyright information and notices</p>
            </div>
        </div>
    </div>
    
    @foreach ($Copyright as $item)
    <form method="POST" action="{{url('/')}}/admin/edit_Copyright" enctype="multipart/form-data" class="px-6 py-6">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                <label for="article-ckeditor" class="block text-sm font-medium text-gray-700 mb-2">
                    <i class="fa fa-file-text-o mr-2"></i> Copyright Content <span class="text-red-500">*</span>
                </label>
                <textarea 
                    id="article-ckeditor" 
                    name="content" 
                ...
                <p class="mt-2 text-xs text-gray-500 flex items-center">
                    <i class="fa fa-lightbulb-o mr-1"></i> Include copyright year, company name, and any additional copyright notices
                </p>
                <script>
