...
<div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-200">
    ...
    <form method="POST" action="{{url('/')}}/admin/edit_privacy/{{$Privacy->id}}" enctype="multipart/form-data" class="px-6 py-6">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input 
                    ...
                    required
                    value="{{ $Privacy->title }}"
                    placeholder="e.g., Privacy Policy - Data Collection"
            ...
            <div>
                <label for="article-ckeditor" class="block text-sm font-medium text-gray-700 mb-2">
                    <i class="fa fa-file-text-o mr-2"></i> Policy Content <span class="text-red-500">*</span>
                </label>
                <textarea 
                    id="article-ckeditor" 
                    name="content" 
                ...
                <p class="mt-2 text-xs text-gray-500 flex items-center">
                    <i class="fa fa-lightbulb-o mr-1"></i> Include details about data collection, usage, storage, and user rights
                </p>
                <script>
        ...
        <div class="mt-8 flex justify-end space-x-3 border-t border-gray-200 pt-6">
            <a href="{{url('/')}}/admin/privacy" class="px-6 py-2.5 border-2 border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all">
