...
{{-- JSON --}}
@verbatim<script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"Macbooks for Hire | Apple Rentals | Laptop Rentals","description":"Experience the power of innovation with our MacBook for hire service. Rent the latest MacBook models for short-term needs. Discover the convenience and performance of Apple technology without the commitment of ownership. Contact us today","image":"https://royaltech.co.ke/uploads/Royaltech-Original-1.png"}</script>
@endverbatim
...
(function() {
    ...
    navItems.forEach(function(item) {
        ...
        // Special handling for macbook-for-hire pages - mark hire button as active
        if (itemPage === 'hire' && currentPath.includes('/macbook-for-hire')) {
            item.classList.add('active');
        }
