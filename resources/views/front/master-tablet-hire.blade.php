...
<meta name="subject" content="Tablets for Hire | Samsung Tablets  | Tablet Rentals">
...
(function() {
    ...
    navItems.forEach(function(item) {
        ...
        // Special handling for tablets-for-hire pages - mark hire button as active
        if (itemPage === 'hire' && (currentPath.includes('/tablets-for-hire') || currentPath.includes('/Tablets-for-hire'))) {
            item.classList.add('active');
        }
